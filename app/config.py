...
def get_settings() -> Settings:
    ...
    source_bridge_config_path = _resolve_optional_path(base_dir, (os.getenv("SOURCE_BRIDGE_CONFIG_PATH") or "").strip() or None)
    settings = Settings(
        ...
        user_agent=os.getenv(
            "USER_AGENT",
            "rss-kindle/0.1 (+https://example.invalid; self-hosted personal reader)",
        ),
